...
const teamsTable = [
    {id: v1(), rank: '1.', img: <img src={manCity} alt=""/>, team: 'Manchester City', MP: 38, W: 29, D: 6, L: 3, PTS: 93},
    ...
    {id: v1(), rank: '6.',img: <img src={manUtd} alt=""/>, team: 'Manchester Utd', MP: 38, W: 16, D: 10, L: 12, PTS: 58},
]
...
const ExperimentTable = () => {
    ...
    const byField = (field:any) => {
        if(!sortTable){
            setSortTable(field)
            return (a:any, b:any) => a[field] > b[field] ? 1 : -1
        }
    }
    const onSort =()=>  table.sort(byField('team'))
    ...
    return (
      <table className='table'>
          ...
          <tr className='tr'>
              ...
              <th className='team' onClick={onSort}>Team</th>
              <th className='MP' onClick={onSort}>MP</th>
              <th className='W' onClick={onSort}>W</th>
              <th className='D' onClick={onSort}>D</th>
              <th className='L' onClick={onSort}>L</th>
              <th className='PTS' onClick={onSort}>PTS</th>
          </tr>
          </thead>
          {tableLeague}
      </table>
